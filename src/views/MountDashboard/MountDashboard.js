...
class MountDashboard extends React.Component {
  ...
  onDownloadClick = (e) => {
    // window.open("http://www.secfs.net/winfsp/rel/","_blank")
    const shell = window.require("electron").shell;
    shell.openExternal("http://www.secfs.net/winfsp/rel/")
    e.preventDefault();
  }
  ...
  render() {
    ...
    return (
      <div data-test="mountDashboardComponent">
        ...
        <div>
          Tip: Windows Needs To Install <a href="#" onClick={(e) => this.onDownloadClick(e)}>WinFSP</a> To Mount
          Successfully
        </div>
      </div>);
  }
