...
const NewMountModal = (props) => {
  ...
  const [isShowAdvanced, setMountShowAdvanced] = useState(false);
    ...
    <div data-test="newMountModalComponent">
      ...
      <Modal isOpen={modal} toggle={toggle} className={className}>
        ...
        <ModalBody>
          ...
          <div>
            {/*<img src={isShowAdvanced ? arrowDown : arrow} style={{width: 20}}/>*/}
            {isShowAdvanced && <i className='icon-arrow-down'/>}
            {!isShowAdvanced && <i className='icon-arrow-right'/>}
            <Button color="link" onClick={() => setMountShowAdvanced(!isShowAdvanced)}>Advanced</Button>
          </div>
